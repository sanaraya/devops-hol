...
Create a new DevOps project either via the Azure Portal or using the DevOps Portal (dev.azure.com). Experience from the previous lab  should help you do this. Once the project is created, you should then go to "Repos" and "Import a repository" and import the https://github.com/microsoft/SmartHotel360-CouponManagement.git (SmartHotel360) project into your Azure Repos to be used in this lab
